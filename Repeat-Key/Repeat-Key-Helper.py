# Hotkey Engineer Plugins Repeat-Key-Helper.py - is a high-performance, modern automation utility for mouse and keyboard tasks. Featuring a clean UI and millisecond precision, it is designed to work as a standalone tool or as a seamless plugin for Hotkey Engineer.
#
...
# ----- > Configure this <-----
MAIN_SCRIPT = os.path.join(SCRIPT_DIR, 'Repeat-Key.py')
